...
public class PegawaiTetap extends Karyawan {
    ...
    public PegawaiTetap(String kode, String nip, String nama, String email, String phone,int jamkerja, String jabatan, double gajipokok) {
    ...
    public double hitungBonus() {
        double bonus = 0;
        if(this.jamkerja > 140){
            bonus = bonus + (this.jamkerja - 100) * 25000;
        }
        return bonus;
    }
    ...
    public void infoTunjangan(){
        ...
        System.out.println(" 4. Tunjangan Kesehatan BPJS dan Telkomedika");
        System.out.println(" 5. Tunjangan Pendidikan");
        System.out.println(" 6. Tunjangan Seragam, Akhir Tahun, Hari Raya");
    }
